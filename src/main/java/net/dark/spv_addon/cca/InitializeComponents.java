...
public class InitializeComponents implements EntityComponentInitializer {
    ...
    public static final ComponentKey<KittyComponent> KITTY =
            ComponentRegistry.getOrCreate(Identifier.of(Spv_addon.MOD_ID, "kitty"), KittyComponent.class);
    ...
    public static final ComponentKey<SanityComponent> SANITY = ComponentRegistry.getOrCreate(
            new Identifier(Spv_addon.MOD_ID, "sanity"), SanityComponent.class
    );
