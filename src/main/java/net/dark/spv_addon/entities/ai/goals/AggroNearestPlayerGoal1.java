 ...
 */
public class AggroNearestPlayerGoal1 extends Goal {
    private final KittyEntity mob;
    ...
    public AggroNearestPlayerGoal1(KittyEntity mob, double maxRange, double aggroSpeed) {
        this.mob = mob;
    ...
    public AggroNearestPlayerGoal1(KittyEntity mob, double maxRange) {
