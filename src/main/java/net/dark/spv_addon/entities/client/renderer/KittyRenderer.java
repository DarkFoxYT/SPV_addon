...
public class KittyRenderer extends DynamicGeoEntityRenderer<KittyEntity> {
    public KittyRenderer(EntityRendererFactory.Context ctx) {
        super(ctx, new kittymodel());
    }
    ...
    private Vec3d getInterpolatedPosition(KittyEntity entity, float partialTick) {
        return new Vec3d(
