...
public class ModBlocks {
    public static final Block HOTEL_WALL = new WallBlock(FabricBlockSettings.copyOf(com.sp.init.ModBlocks.WALL_BLOCK).hardness(-1.0F).solid().noBlockBreakParticles().sounds(SprintBlockSoundGroup.WALL));
    public static final Block C_WALL = new WallBlock(FabricBlockSettings.copyOf(com.sp.init.ModBlocks.WALL_BLOCK).hardness(-1.0F).solid().noBlockBreakParticles().sounds(SprintBlockSoundGroup.CARPET));
    public static final Block KITTY_WALL = new WallBlock(FabricBlockSettings.copyOf(com.sp.init.ModBlocks.WALL_BLOCK).hardness(-1.0F).solid().noBlockBreakParticles().sounds(SprintBlockSoundGroup.WALL));
    public static final Block KITTY_FLOOR = new CarpetBlock(FabricBlockSettings.copyOf(com.sp.init.ModBlocks.CARPET_BLOCK).hardness(-1f).noBlockBreakParticles().sounds(SprintBlockSoundGroup.CARPET));
    public static final Block KITTY_ROOF = new CarpetBlock(FabricBlockSettings.copyOf(com.sp.init.ModBlocks.CEILING_TILE).hardness(-1f).noBlockBreakParticles().sounds(SprintBlockSoundGroup.CARPET));
    ...
    public static final Block HOTEL_FLOOR = new CarpetBlock(FabricBlockSettings.copyOf(com.sp.init.ModBlocks.CARPET_BLOCK).hardness(-1f).noBlockBreakParticles().sounds(SprintBlockSoundGroup.CARPET));
