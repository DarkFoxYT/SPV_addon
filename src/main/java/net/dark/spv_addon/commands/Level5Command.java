    ...
    public static void register(CommandDispatcher<ServerCommandSource> dispatcher) {
        ...
        dispatcher.register(CommandManager.literal("level5")
                ...
                .executes(context -> {
                    ...
                    BlockPos spawn = BlockPos.ofFloored(com.sp.init.BackroomsLevels.getCurrentLevelsOrigin(BackroomsLevels.LEVEL5_WORLD_KEY));
        ...
        dispatcher.register(CommandManager.literal("RUN")
                ...
                .executes(context -> {
                    ...
                    BlockPos spawn = BlockPos.ofFloored(com.sp.init.BackroomsLevels.getCurrentLevelsOrigin(BackroomsLevels.LEVELRUN_WORLD_KEY));
